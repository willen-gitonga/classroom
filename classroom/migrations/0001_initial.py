# Generated by Django 2.0.1 on 2019-07-31 20:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Have_you_participated_in_a_Moringa_School_training_before', models.CharField(choices=[('Yes', 'Yes'), ('No', 'NO'), ('Maybe', 'Maybe')], max_length=100, null=True)),
                ('Are_you_interested_in_joining_Moringa_Core_after_Moringa_Prep', models.CharField(choices=[('Yes', 'Yes'), ('No', 'NO'), ('Maybe', 'Maybe')], max_length=100, null=True)),
                ('Where_did_you_hear_about_Moringa_School', models.CharField(choices=[('Facebook', 'Facebook'), ('Twitter', 'Twitter'), ('Alumni', 'Alumni'), ('Event', 'Event'), ('Instagram', 'Instagram'), ('Moringa-Website', 'Moringa-Website'), ('Referall', 'Referall'), ('Google', 'Google'), ('Nairobi-Tech-Week', 'Nairobi-Tech-Week'), ('Other', 'Other')], max_length=100, null=True)),
                ('Whcih_avenue_was_most_influential_in_joining_Moringa_School', models.CharField(choices=[('Facebook', 'Facebook'), ('Twitter', 'Twitter'), ('Alumni', 'Alumni'), ('Event', 'Event'), ('Instagram', 'Instagram'), ('Moringa-Website', 'Moringa-Website'), ('Referall', 'Referall'), ('Google', 'Google'), ('Nairobi-Tech-Week', 'Nairobi-Tech-Week'), ('Other', 'Other')], max_length=100, null=True)),
                ('Do_you_understand_that_you_need_to_pay_the_full_amount', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_pass', models.BooleanField(default=False, verbose_name='Passed student')),
